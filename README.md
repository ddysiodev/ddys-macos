...
- 设置中心：API 地址、站点地址、缓存时间、刷新间隔、通知、主题、打开方式可配置。
...
DDYS macOS 不内置账号系统。本地收藏、稍后看、历史、备注、订阅和设置默认保存在当前 Mac，不会主动上传到第三方服务。应用只会在用户执行搜索、刷新、订阅检查、诊断或打开内容时请求配置的 DDYS API / 站点地址。
